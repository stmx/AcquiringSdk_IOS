...
class AcquiringAlertViewController: UIViewController {
    static func create() -> AcquiringAlertViewController {
        let alert = AcquiringAlertViewController(nibName: "AcquiringAlertViewController", bundle: Bundle.tinkoffASDKUI)
    ...
    public func present(on presentingViewController: UIViewController, title: String, icon: AcquiringAlertIconType = .success, autoCloseTime: TimeInterval = 3) {
        ...
        case .error:
            imageViewAletIcon.image = UIImage(named: "cancel", in: Bundle.tinkoffASDKUI, compatibleWith: nil)
        default:
            imageViewAletIcon.image = UIImage(named: "done", in: Bundle.tinkoffASDKUI, compatibleWith: nil)
        }
