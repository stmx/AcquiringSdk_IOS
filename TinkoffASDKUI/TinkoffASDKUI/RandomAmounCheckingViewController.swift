...
class RandomAmounCheckingViewController: ConfirmViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "TextFieldTableViewCell", bundle: Bundle.tinkoffASDKUI), forCellReuseIdentifier: "TextFieldTableViewCell")
...
extension RandomAmounCheckingViewController: UITextFieldDelegate {
    ...
    func textFieldShouldBeginEditing(_ textField: UITextField) -> Bool {
        if let accessoryView = Bundle.tinkoffASDKUI.loadNibNamed("ButtonInputAccessoryView", owner: nil, options: nil)?.first as? ButtonInputAccessoryView {
