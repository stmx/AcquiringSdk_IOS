...
class CardsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        tableView.register(UINib(nibName: "PaymentCardTableViewCell", bundle: Bundle.tinkoffASDKUI), forCellReuseIdentifier: "PaymentCardTableViewCell")
        tableView.register(UINib(nibName: "StatusTableViewCell", bundle: Bundle.tinkoffASDKUI), forCellReuseIdentifier: "StatusTableViewCell")
        tableView.register(UINib(nibName: "AddCardTableViewCell", bundle: Bundle.tinkoffASDKUI), forCellReuseIdentifier: "AddCardTableViewCell")
        tableView.register(UINib(nibName: "InpuCardtRequisitesTableViewCell", bundle: Bundle.tinkoffASDKUI), forCellReuseIdentifier: "InpuCardtRequisitesTableViewCell")
